...
#' dimsumms__aa_properties_pca_singles_loadings
#'
...
#' @export
dimsumms__aa_properties_pca_singles_loadings <- function(
  input_dt,
  aa_properties_file,
  selected_identifiers = NULL
  ){
  #AA properties PCA
  exp_pca <- dimsumms__aa_properties_pca(aa_properties_file = aa_properties_file, selected_identifiers = selected_identifiers)
  #Mut codes
